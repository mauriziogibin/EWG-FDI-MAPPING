...
table.I.errors <- 
  lapply(1:length(table.I.errors),function(x){
    ...
    # DT <- DT[!(country=='FRA' & rectangle_lat==43.25 & rectangle_lon==2.75),]
    # DT <- DT[!(country=='HRV' & rectangle_lat==43.25 & rectangle_lon==17.75),]
    return(DT)
    }
...
#   else{table.I.errors[[x]]}
#   })
names(table.I.errors)[-8] <-   gsub('.{8}$','',names(table.I.errors)[-8])
names(table.I.errors)[8] <-   gsub('.csv$','',names(table.I.errors)[8])
...
missing.subregion <- (table.I.errors[[8]])
table.I.errors <- table.I.errors[-8]
missing.subregion <-
...
newnames <- c(names(table.I.errors[1]),
              ...
              names(table.I.errors[8]),
              #names(table.I.errors[12]),
              names(table.I.errors[13]))
table.I.errors <- list( rbindlist(table.I.errors[1]),
                        rbindlist(table.I.errors[2:6]),
                        #rbindlist(table.I.errors[3:10]),
                        #rbindlist(table.I.errors[11]),
                        rbindlist(table.I.errors[8:12]),
                        rbindlist(table.I.errors[13]))
