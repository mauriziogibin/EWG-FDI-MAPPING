...
fwrite(resultEU28DT, './dissemination/old_format/EU28/csv/spatial_effort_tableau_pts_EU28.csv')
...
st_write(
  resultEU28_sf,
  './dissemination/old_format/EU28/shp/spatial_effort_tableau_EU28.shp',
  delete_dsn = T
)
resultEU28 <- NULL;
resultEU28DT <- NULL;
...
fwrite(resultEU27DT, './dissemination/old_format/EU27/csv/spatial_effort_tableau_pts_EU27.csv')
...
st_write(
  resultEU27_sf,
  './dissemination/old_format/EU27/shp/spatial_effort_tableau_EU27.shp',
  delete_dsn = T
)
